...
public class addwomenclass {
    ...
    public String getPpBMI(){
        return ppBMI;
    }
    public void setPpBMI(String ppBMI){
        this.ppBMI=ppBMI;
    }

    public String getPpBMICatogey(){
        return ppBMICatogey;
    }
    public void setPpBMICatogey(String ppBMICatogey){
        this.ppBMICatogey=ppBMICatogey;
    }
